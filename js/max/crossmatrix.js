...
function draw()
{
	with (sketch)
	{
		...
		colstep = 2.0 / ncols; // how much to move over per column
		rowstep = 2.0 / nrows; // how much to move over per row
...
function onclick(x,y)
{
	...
	x_click = Math.floor((worldx + 1.0) / colwidth); // which column we clicked
	y_click = Math.floor((1.0 - worldy) / rowheight); // which row we clicked
