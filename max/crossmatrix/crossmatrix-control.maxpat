...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"comment" : "",
					"hint" : "Commands to crossmatrix.jso",
					"id" : "obj-1",
					"ignoreclick" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 57.5, 192.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 13.0, 86.0, 135.571426, 20.0 ],
					"text" : "funnel 7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 13.0, 52.0, 155.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 13.0, 123.0, 32.5, 18.0 ],
					"text" : "$1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 13.0, 156.0, 108.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 22.5, 148.0, 22.5, 148.0 ],
					"source" : [ "obj-17", 0 ]
				}
