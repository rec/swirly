...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.5, 418.5, 34.0, 20.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 324.5, 366.0, 76.0, 21.0 ],
					"text" : "metro 256n",
					"varname" : "LFO-metro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 297.5, 455.5, 37.0, 20.0 ],
					"text" : "timer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 442.0, 455.5, 127.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 442.0, 386.0, 62.0, 21.0 ],
					"text" : "metro 4n"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 442.0, 418.5, 163.0, 21.0 ],
					"text" : "transport"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 346.599976, 455.5, 71.0, 21.0 ],
					"text" : "snapshot~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 346.599976, 413.0, 87.0, 20.0 ],
					"text" : "phasor~ 1 bbu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 188.0, 390.5, 41.0, 20.0 ],
					"text" : "gate~"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 188.0, 418.5, 48.0, 57.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 355.5, 26.0, 26.0 ]
				}
